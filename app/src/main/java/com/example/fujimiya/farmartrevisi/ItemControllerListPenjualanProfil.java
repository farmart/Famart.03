...
public class ItemControllerListPenjualanProfil extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public ItemControllerListPenjualanProfil(View itemView) {
        super(itemView);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    for (DataSnapshot child : dataSnapshot.child(ProfilUserActivity.keyF).child("zlist").getChildren()) {
                        ...
                        if (child.getKey().equals(MyRecyclerAdapterListPenjualanProfil.Fkunci.get(urut))) {
