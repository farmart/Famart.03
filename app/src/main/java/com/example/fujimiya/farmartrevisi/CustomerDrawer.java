...
public class CustomerDrawer extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.replace(R.id.fragmennya_maps, mapsFragment);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.beranda) {
            ...
            fragmentTransaction.replace(R.id.fragmennya_maps, mapsFragment);
            fragmentTransaction.commit();
        } else if (id == R.id.terdekat) {

            KomoditiTerdekatFragment komoditiTerdekatFragment = new KomoditiTerdekatFragment();
            android.support.v4.app.FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.fragmennya_maps, komoditiTerdekatFragment);
            fragmentTransaction.commit();

        }else if (id == R.id.keluar_customer){
